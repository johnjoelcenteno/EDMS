...
namespace DPWH.EDMS.Web.Client.Pages.DataLibrary.RecordTypes.PersonalRecords;

public class PersonalRecordsManagementBase : RecordTypesFormComponentBase
{
    ...
    protected virtual async Task LoadLibraryData()
    {
        ...
        {
            var dataLibraryResults = await RecordTypesService.QueryByCategoryRecordTypesAsync("Personal Records");
