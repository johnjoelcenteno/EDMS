...
namespace DPWH.EDMS.Web.Client.Pages.DataLibrary.DataLibraries.Purposes;

public class PurposesManagementBase : GridBase<DataManagementModel>
{
    ...
    protected string UriName = "Purposes";
    protected string DataType = "Purposes";
    ...
    protected override void OnParametersSet()
    {
        ...
        BreadcrumbItems = new List<BreadcrumbModel>
        {
            ...
            new() { Text = "Purposes", Url = $"/data-library/purposes" },
