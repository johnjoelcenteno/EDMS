...
public record CreateRecordRequest(string? EmployeeNumber, string? Email, string Claimant, DateTimeOffset DateRequested, string? AuthorizedRepresentative,
    Guid? SupportingFileValidId, Guid? SupportingFileAuthorizationDocumentId, Guid[] RequestedRecords, string Purpose, string? OtherPurpose, string? FullName, string? Remarks);
