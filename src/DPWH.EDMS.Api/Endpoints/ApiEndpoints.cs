...
public static class ApiEndpoints
{
    ...
    public static class RecordTypes
    {
        ...
        public const string QueryByCategory = $"{Base}/QueryByCategory/{{category}}";
    ...
    public static class RecordRequest
    {
        ...
        public static class Documents
        {
            ...
            public const string GetTransmittalReceipt = $"{Base}/transmittalreceipt/{{id:guid}}";
    ...
    public static class Lookups
    {
        ...
        public const string PersonalRecords = $"{Base}/personalrecords";        
        public const string EmployeeDocuments = $"{Base}/employeedocuments";
